...
{
    $data["enabled"]=0;
    $functions->disableData("inquiry_form_location",$data,"id=".$_POST["delete"]);
}
?>
      ...
      <div class="row">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h1>Students Inquiry Location</h1>
            </div>
<?php
// if(checkPrivilage($_SESSION["user_type"],"admin"))
// {
$outcome=$functions->selectData("inquiry_form_location","enabled=1");
