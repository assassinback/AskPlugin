      ...
      <div class="row">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h1>Students Sources</h1>
            </div>
<?php
// if(checkPrivilage($_SESSION["user_type"],"admin"))
// {
    $outcome=$functions->selectData("source","enabled=1");
...
echo "<th class='text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7'>Source Name</th>";
